...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/RefundMessage.css"/>
</head>
<body>
<div id="app">
    <div id="appheader">
    ...
    <div id="appbody">
        <div class="layui-row">
            <div class="layui-col-md6 layui-col-md-offset3">
                <div id="game_header_text">游戏退款</div>
                <div id="game_refund_div">
                    <div id="game_refound_bgc_div">
                        <div id="game_fBody"> </div>
                    </div>
                </div>
            </div>
        </div>
...
<script src="${pageContext.request.contextPath}/JS/RefundMessage.js"></script>
